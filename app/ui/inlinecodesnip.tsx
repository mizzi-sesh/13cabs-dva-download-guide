...
export default function InlineCodeSnip({
    ...
    return(
        <code className={`inline rounded-md text-sm border-gray-300 dark:border-gray-700 border p-0.5 bg-gray-200 dark:bg-gray-800 ${fira_code.className}`}>{children}</code>
    )
}