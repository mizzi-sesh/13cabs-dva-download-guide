...
export default function Chapter(props: {children: React.ReactNode, link: string, name: string, className?: string}){
        ...
        <ul className={`last-of-type:pb-3 dark-theme`}>
            <li className="my-1.5 ml-[3px]" data-active={pathname === props.link}>
                <Link className={clsx({'font-black dark:text-gray-400 text-gray-900': pathname !== props.link, },
                 ...
                 `justify-between rounded-md py-1 pl-5 text-left text-sm overflow-auto text-gray-1000 font-medium ${props.className}`)} href={props.link}>
                {props.name}   
                </Link>
